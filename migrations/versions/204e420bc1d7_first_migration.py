...
Revision ID: 204e420bc1d7
Revises: None
Create Date: 2015-03-10 16:19:10.626013

"""

# revision identifiers, used by Alembic.
revision = '204e420bc1d7'
down_revision = None
...
def upgrade():
    ...
    sa.Column('stop_desc', sa.String(length=250), nullable=True),
    ...
    sa.Column('stop_calle', sa.String(length=250), nullable=True),
    sa.Column('stop_numero', sa.String(length=50), nullable=True),
    sa.Column('stop_entre', sa.String(length=250), nullable=True),
    sa.Column('stop_esquina', sa.String(length=250), nullable=True),
    ...
    sa.ForeignKeyConstraint(['trip_id'], ['trips.trip_id'], onupdate='CASCADE'),
    sa.PrimaryKeyConstraint('trip_id')
    )
